# Changing self parametr to slf and chandan  = Nothing happen (but not a good practice)
...
class Train:
    ...
    def book(chandan,fro,to):
        print(f"Ticket is booked in train No.: {chandan.trainNo} from {fro} to {to}")
